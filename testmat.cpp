...
// [[Rcpp::export]]
NumericMatrix CumH_c_IS_mat(NumericMatrix v1, NumericMatrix v2, NumericVector u, NumericVector cest, NumericVector bref, bool affp, int type) {
  int n = v1.nrow();
  
  NumericMatrix Hvec(n,2);
  NumericVector uv = u;

  double finalH0, finalH1;
